...
export default function ResultSearchCourses(props) {
    ...
    const getJob = async () => {
       ...
       try {
           return await http.get(`${domain}/api/jobs`);
        ...
        return course.map((course, index) => {
            return <div className="mt-4" key={index}>
                <div className="cardServices"> 
                    {/* <h6>Under US${course.price}</h6> */}
                    <div className="card" style={{ width: '18rem' }}>
                        <div className="cardDetail">
                            <a href="#"><img className="card-img-top" src={course.image} alt /></a>
                            <div className="card-body">
                                ...
                                <h3 className="contentCourse"><a href="#">{course.name}</a></h3>
